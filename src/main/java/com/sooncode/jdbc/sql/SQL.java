...
public class SQL {
	...
	public SQL TABLE(Class<?> clas) {
		...
		String tableName = T2E.field2Column(clas.getSimpleName());
	...
	public SQL SUM(String fieldName) {
		String column = T2E.field2Column(fieldName);
	...
	public SQL EQ(String fieldName, Object value) {
		String sql = "";
		if (value != null) {
			sql = " " + T2E.field2Column(fieldName) + "='" + value + "'";
		} 
	...
	public SQL LIKE_THIS(String fieldName, Object value) {
		String sql = "";
		if (value != null) {
			sql = " AND " + T2E.field2Column(fieldName) + " LIKE '%" + value + "'";
		}
		this.sqlString = this.sqlString + sql;
		return this;
	}
	...
	public SQL LIKE(String fieldName, Object value) {
		String sql = "";
		if (value != null) {
			sql = " " + T2E.field2Column(fieldName) + " LIKE '%" + value + "%'";
		}
		this.sqlString = this.sqlString + sql;
		return this;
	}
	...
	public SQL BETWEEN(String fieldName, Object value1, Object value2) {
		...
		if (value1 != null && value2 != null) {
			sql = " AND " + T2E.field2Column(fieldName) + " BETWEEN '" + value1 + "' AND '" + value2 + "'";
		}
	...
	public SQL AS(String key){
		this.sqlString = this.sqlString + "AS "+T2E.field2Column(key)+" ";
		return this;
	}
	public SQL GROUP_BY(String key){
		this.sqlString = this.sqlString + " GROUP BY "+T2E.field2Column(key)+" ";
		return this;
	}
	public SQL DISTINCT(String key){
		this.sqlString = this.sqlString + " DISTINCT "+T2E.field2Column(key)+" ";
		return this;
	}
	/**
	 * mysql 时间函数 
	...
	public SQL DATE(String key,String startDate,String endDate){
		this.sqlString = this.sqlString + " DATE("+T2E.field2Column(key)+")BETWEEN '"+startDate+"' AND '"+endDate+"'";
		return this;
	}
	/**
	 * 分页功能
